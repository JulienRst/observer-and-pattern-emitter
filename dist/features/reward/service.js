...
var RewardService = /** @class */ (function () {
    function RewardService(config) {
        this.rewardRepository = config.rewardRepository;
        this.logger = config.logger;
    }
    RewardService.prototype.create = function (user, reward) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                this.logger('RewardService', "Creating reward ".concat(reward, " for ").concat(user));
